...
import { useProductItems } from '../../hooks/product.hook';
import Loader from '../../common/Loader';
import Breadcrumb from '../../components/Breadcrumb';

const ProductItems = () => {
  const params = useParams();
  const { data: productItems, isPending } = useProductItems(params.id);
  if (isPending) return <Loader />;
  return (
    <>
      <Breadcrumb pageName={`product item list - ${params.id}`} />
